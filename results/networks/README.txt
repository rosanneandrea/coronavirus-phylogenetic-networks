...
Different file types:
  ...
  -- .seq is an output file from the Semi-Temporal algorithm, which contains the Tree-Child Sequence that can be used to construct the corresponding phylogenetic network
